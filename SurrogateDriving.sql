...
('215BG2', 'Red', 'Civic', 'Honda', '2015', 'Sedan', 'Automatic'),
('315BG2', 'Blue', 'Corolla', 'Toyota', '2010', 'Sedan', 'Automatic'),
('215CG1', 'Black', 'Rav4', 'Toyota', '2015', 'SUV', 'Automatic'),
('115DG2', 'Green', 'F150', 'Ford', '2019', 'Truck', 'Manual'),
('415AC2', 'White', 'Elantra', 'Hyubdai', '2015', 'Sedan', 'Automatic'),
('015ZG3', 'Orange', 'Sonata', 'Hyundai', '2009', 'Sedan', 'Manual'),
('915CG0', 'Black', '520i', 'BMW', '2020', 'Sedan', 'Automatic'),
('330GH1', 'Navy', 'G80', 'Genesis', '2021', 'Sedan', 'Automatic'),
('225UT0', 'Black', 'Camry', 'Toyota', '2007', 'Sedan', 'Manual'),
('940KJ2', 'White', 'Altima', 'Nissan', '2011', 'Sedan', 'Automatic'),
('847AG2', 'Blue', 'Santafe', 'Hyundai', '2017', 'SUV', 'Manual'),
('345GH2', 'Green', 'Prius', 'Toyota', '2009', 'Sedan', 'Automatic'),
('135IY2', 'Blue', 'Forte', 'Kia', '2020', 'Sedan', 'Automatic'),
('875BG2', 'Violet','Silverado', 'Chevrolet', '2022', 'Truck', 'Automatic'),
('005BD1', 'White', 'Navigator', 'Lincoln', '2022', 'SUV', 'Automatic'),
('995AC2', 'Black', 'Sorento', 'Kia', '2008', 'SUV', 'Manual'),
('885ZG0', 'Brown', 'Telluride', 'Kia', '2021', 'SUV', 'Automatic'),
('015KG3', 'White', 'Compass', 'Jeep', '2013', 'SUV', 'Automatic'),
('215BG1', 'Black', 'CLA250', 'Mercedes-Benz', '2022', 'Sedan', 'Automatic'),
('098MN2', 'Black', 'R8', 'Audi', '2019', 'Sedan', 'Automatic');
...
CONSTRAINT cusomter_rating_constraint CHECK (customer_rating BETWEEN 1 AND 5),
